...
<c:import url="../layout/app.jsp">
    <c:param name="content">
        ...
        <p>作成日時：<fmt:formatDate value="${message.created_at}" pattern="yyyy年MM月dd日HH時mm分ss秒" /></p>
        <p>更新日時：<fmt:formatDate value="${message.updated_at}" pattern="yyyy年MM月dd日HH時mm分ss秒" /></p>
